...
export function ChatInterface({ chatId }: ChatInterfaceProps) {
  ...
  }, [chatId, selectedModel, isLoadingModels]); // CORRECTED: Removed unnecessary dependencies
  ...
  }, [chatId, loadModels, triggerInitialResponse]); // CORRECTED: Added triggerInitialResponse to dependency array
